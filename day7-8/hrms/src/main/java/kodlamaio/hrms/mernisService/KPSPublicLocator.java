...
public class KPSPublicLocator extends org.apache.axis.client.Service implements KPSPublic {
    ...
    public KPSPublicSoap_PortType getKPSPublicSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            KPSPublicSoap_BindingStub _stub = new KPSPublicSoap_BindingStub(portAddress, this);
    ...
    // Use to get a proxy class for KPSPublicSoap12
    private java.lang.String KPSPublicSoap12_address = "https://tckimlik.nvi.gov.tr/Service/KPSPublic.asmx";

    public java.lang.String getKPSPublicSoap12Address() {
        return KPSPublicSoap12_address;
    }

    // The WSDD service name defaults to the port name.
    private java.lang.String KPSPublicSoap12WSDDServiceName = "KPSPublicSoap12";

    public java.lang.String getKPSPublicSoap12WSDDServiceName() {
        return KPSPublicSoap12WSDDServiceName;
    }

    public void setKPSPublicSoap12WSDDServiceName(java.lang.String name) {
        KPSPublicSoap12WSDDServiceName = name;
    }

    public KPSPublicSoap_PortType getKPSPublicSoap12() throws javax.xml.rpc.ServiceException {
       java.net.URL endpoint;
        try {
            endpoint = new java.net.URL(KPSPublicSoap12_address);
        }
        catch (java.net.MalformedURLException e) {
            throw new javax.xml.rpc.ServiceException(e);
        }
        return getKPSPublicSoap12(endpoint);
    }

    public KPSPublicSoap_PortType getKPSPublicSoap12(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            KPSPublicSoap12Stub _stub = new KPSPublicSoap12Stub(portAddress, this);
            _stub.setPortName(getKPSPublicSoap12WSDDServiceName());
            return _stub;
        }
        catch (org.apache.axis.AxisFault e) {
            return null;
    ...
    public void setKPSPublicSoap12EndpointAddress(java.lang.String address) {
        KPSPublicSoap12_address = address;
    }
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (KPSPublicSoap_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                KPSPublicSoap_BindingStub _stub = new KPSPublicSoap_BindingStub(new java.net.URL(KPSPublicSoap_address), this);
                _stub.setPortName(getKPSPublicSoapWSDDServiceName());
                return _stub;
            }
            if (KPSPublicSoap_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                KPSPublicSoap12Stub _stub = new KPSPublicSoap12Stub(new java.net.URL(KPSPublicSoap12_address), this);
                _stub.setPortName(getKPSPublicSoap12WSDDServiceName());
                return _stub;
            }
        }
    ...
    public java.rmi.Remote getPort(javax.xml.namespace.QName portName, Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        ...
        else if ("KPSPublicSoap12".equals(inputPortName)) {
            return getKPSPublicSoap12();
        }
        else  {
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://tckimlik.nvi.gov.tr/WS", "KPSPublicSoap12"));
        }
...
if ("KPSPublicSoap12".equals(portName)) {
            setKPSPublicSoap12EndpointAddress(address);
        }
        else 
{ // Unknown Port Name
